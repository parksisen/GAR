(function (wHandle, wjQuery) {
     ...
     *
     */
    var CONNECTION_URL = "3.0.20.61:8001";
    /**
    ...
    var chat_msg_flod = "Type Slower! Spam Dectected.";
    var last, diff;
    var myx = 0;
    var myy = 0;
            ...
            switch (event.keyCode) {
                ...
                case 13:
                    if (isTyping) {
                        ...
                        if ((chattxt.length < 101) && (chattxt.length > 0)) {
                            sendChat(chattxt);
                        }
    ...
    function drawChatBoard() {
        ...
        for (var i = 0; i < (len - from); i++) {
            ...
            var chatText = new UText(18, '#2B547E');
	...
	logoimage.src = "http://www125.lunapic.com/do-not-link-here-use-hosting-instead/146068330024344?280872350";
	var size = ~~ (canvasWidth/2);
    ctx.drawImage(logoimage, 5280, 4800, size, size);
    }
    ...
    function drawLeaderBoard() {
        ...
        if (null != teamScores || 0 != leaderBoard.length)
            if (null != teamScores || showName) {
                ...
                var b;
                var leaderColors = ["#FF5656", "#EC6856", "#D97B56", "#C68E56", "#B3A156", "#A1B356", "#8EC656", "#7BD956", "#68EC56", "#56FF56", "#66FF66", "#77FF77", "#88FF88", "#99FF99", "#AAFFAA", "#BBFFBB", "#CCFFCC", "#DDFFDD", "#EEFFEE", "#FFFFFF", "#FFFFFF", "#FFFFFF", "#FFFFFF", "#FFFFFF", "#FFFFFF"];
                if (null == teamScores) {
