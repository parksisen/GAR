...
function Experimental() {
    ...
    this.motherUpdateInterval = 1; // How many ticks it takes to update the mother cell (1 tick = 50 ms)
...
MotherCell.prototype.update = function(gameServer) {
    ...
    // Spawn food
    var maxFood = 1000; // Max food spawned per tick
...
MotherCell.prototype.spawnFood = function(gameServer) {
    ...
    var angle = Math.random() * 100; // (Math.PI * 2) ??? Precision is not our greatest concern here
    var r = this.getSize();
    var pos = {
    ...
    // Move engine
    f.angle = angle;
    var dist = (Math.random() * 50) + 22; // Random distance
